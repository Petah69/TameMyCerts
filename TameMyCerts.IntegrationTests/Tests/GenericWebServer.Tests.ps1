...
Describe 'GenericWebServer.Tests' {
    ...
    It 'Given flag is enabled, and SAN extension is present, no certificate is issued' {
    ...
    It 'Given flag is enabled, and StartDate extension is present, a certificate is issued with correct date' {
